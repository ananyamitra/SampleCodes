...
step 1 - The client appilcation needs to identify itself to the authorization server using a Client Id and a Client secret. The authorization server gives back a token to the client application.
